...
def read_logical_port(address: int, resolution: float, i2c_channel: int = 0) -> list:
    """
...
def check_if_exist_device(i2c_channel: int = 0, address: int = 0x48) -> bool:
    """
...
if __name__ == "__main__":
    try:
        ...
        if check_if_exist_device(i2c_channel, address):
            voltages = read_logical_port(address, resolution, i2c_channel)
